...
print(
    f"{n} sample paris of {input_image_path, gt_image_path} are added at {input_save_path, gt_save_path}."
)
...
n = geo.split_image(
    input_tif_image_path, input_save_image_path, crop_size, repetition_rate, overwrite
)
